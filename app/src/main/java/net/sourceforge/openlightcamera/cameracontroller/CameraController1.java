...
public class CameraController1 extends CameraController {
    ...
    public CameraFeatures getCameraFeatures() throws CameraControllerException {
        ...
        camera_features.video_sizes.add(new CameraController.Size(1280, 720));
        camera_features.video_sizes.add(new CameraController.Size(960, 720));// test
        camera_features.video_sizes.add(new CameraController.Size(720, 480));
        camera_features.video_sizes.add(new CameraController.Size(640, 480));
        camera_features.video_sizes.add(new CameraController.Size(320, 240));
        // sizes are usually already sorted from high to low, but sort just in case
        ...
        camera_features.preview_sizes.add(new CameraController.Size(1280, 720));
        camera_features.preview_sizes.add(new CameraController.Size(960, 720));
        camera_features.preview_sizes.add(new CameraController.Size(720, 480));
        camera_features.preview_sizes.add(new CameraController.Size(640, 480));
        camera_features.preview_sizes.add(new CameraController.Size(320, 240));
